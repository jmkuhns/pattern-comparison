...
for (i = 0; i<30; i++){
  patterns_page_1_left.push( "1_" + nums_01[i] + "_01.png")
}

var patterns_page_1_right = [];
for (i = 0; i<30; i++){
  patterns_page_1_right.push( "1_" + nums_01[i] + "_02.png")
}

var patterns_page_2_left = [];
for (i = 0; i<30; i++){
  patterns_page_2_left.push( "2_" + nums_01[i] + "_01.png")
}

var patterns_page_2_right = [];
for (i = 0; i<30; i++){
  patterns_page_2_right.push( "2_" + nums_01[i] + "_02.png")
}
// 37 = same; 39 = diff
