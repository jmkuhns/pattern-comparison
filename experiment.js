...
var practice_trials = {
  ...
  stimulus: function(){
    var html = [
      {'<div class="row"><div class="column"><img src=' + jsPsych.timelineVariable('left') + ' style="width:100px;height:100px";></img></div><div class="column"><img src=' + jsPsych.timelineVariable('right') + '  style="width:100px;height:100px";></img></div></div>'}];
    return html}   ,
  timeline_variables: [
